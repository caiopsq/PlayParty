            ...
            <div className="nossos-clientes__container">
                ...
                <section className="flex h-screen justify-center items-center w-[300]" style={{ 'background-color': '#dcdddf' }}>
                    <div className="h-100 max-h-lvh w-full  rouded-2xl py-16 overflow-hidden grid">
                        <Marquee gradient pauseOnClick="true" gradientColor="#dcdddf" className="rounded-2xl  py-3 overflow-hidden grid  ">
                ...
                <section className="flex h-screen justify-center items-center w-[300]" style={{ 'background-color': '#dcdddf' }}>
                    <div className="h-100 max-h-lvh w-full  rouded-2xl py-16 overflow-hidden grid">
                        <Marquee gradient pauseOnClick="true" direction="right" gradientColor="#dcdddf" className="rounded-2xl  py-3 overflow-hidden grid  ">
